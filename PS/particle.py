...
class Particle:
    ...
    def __init__(self,pdgid,momentum,col=[0,0],final=True):
        self.Set(pdgid,momentum,col,final)

    def __repr__(self):
        return "{0} {1} {2} {3}".format(self.pid,self.mom,self.col,self.final)

    def __str__(self):
        return "{0} {1} {2} {3}".format(self.pid,self.mom,self.col,self.final)

    def Set(self,pdgid,momentum,col=[0,0],final=True):
        self.pid = pdgid
        self.mom = momentum
        self.col = col
        self.final = final
